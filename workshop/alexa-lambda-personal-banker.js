...
function getWelcomeResponse(callback) {
    ...
    const speechOutput = '<speak>  <prosody rate="90%"> <prosody pitch="high"> Welcome to Personal Banker </prosody></prosody><break time="2s"/> <prosody rate="90%"> <prosody pitch="high"> to know about your account detail, say what is my account balance? " <break time="1s"/> To hear about your loan balance, say loan balance. <break time="1s"/> To hear know about loan product, say what is the rate of loan product.</prosody></prosody></speak>' ;
...
// Dispatch to your skill's intent handlers
    if (intentName === 'AMAZON.HelpIntent') {
        ...
        var LoanType = intent.slots.LoanType.value;
        if (LoanType == 'car'){
             speechOutput = '<speak>The current rate for car loan is 0.04%. To know more about the home loan rate, say home. Or say Account Balance to know your account. Or say Loan balance to know your loan balance. </speak>';       
         } else if (LoanType == 'home') {
             speechOutput = '<speak>The current rate for home loan is 0.03%. To know more about the home car rate, say car. Or say Account Balance to know your account. Or say Loan balance to know your loan balance.</speak>';            
         }   else {
            speechOutput = '<speak>Sorry what loan type? home or car?</speak>'
            }
        ...
        if (AccountType == 'checking'){
            ...
            speechOutput = '<speak>Sorry what account? Saving or checking?</speak>'
        }     
        callback(sessionAttributes,buildSpeechletResponse(cardTitle, speechOutput, repromptText, shouldEndSession));
    }
